...
#define SPI_1_REMOVE_SPI_MASTER_PINS         (1u)
#define SPI_1_REMOVE_SPI_MASTER_SCLK_PIN     (1u)
#define SPI_1_REMOVE_SPI_MASTER_MOSI_PIN     (1u)
#define SPI_1_REMOVE_SPI_MASTER_MISO_PIN     (1u)
...
#define SPI_1_REMOVE_SPI_SLAVE_PINS          (0u)
#define SPI_1_REMOVE_SPI_SLAVE_MOSI_PIN      (0u)
#define SPI_1_REMOVE_SPI_SLAVE_MISO_PIN      (0u)
