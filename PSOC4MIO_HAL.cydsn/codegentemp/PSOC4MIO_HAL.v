// ======================================================================
// PSOC4MIO_HAL.v generated from TopDesign.cysch
// 05/31/2016 at 18:08
...
// DieTemp_P4_v1_0(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=coretemp, CY_INSTANCE_SHORT_NAME=coretemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=coretemp, )
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=LCD, )
module SW_Tx_UART_v1_50_7 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b1f4b87a-9fc5-4b51-852f-53278b049996/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__chan1_net;
	wire [0:0] tmpFB_0__chan1_net;
	wire [0:0] tmpIO_0__chan1_net;
	wire [0:0] tmpINTERRUPT_0__chan1_net;
	electrical [0:0] tmpSIOVREF__chan1_net;
	...
	cy_psoc3_pins_v1_10
		...
		chan1
		 (.oe(tmpOE__chan1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__chan1_net[0:0]}),
		  .analog({Net_914}),
		  .io({tmpIO_0__chan1_net[0:0]}),
		  .siovref(tmpSIOVREF__chan1_net),
		  .interrupt({tmpINTERRUPT_0__chan1_net[0:0]}),
		  .annotation({Net_767}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__chan1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_70_2 sectimer (
        ...
        .tc(Net_335),
        .clock(Net_457));
    defparam sectimer.CaptureCount = 2;
    defparam sectimer.CaptureCounterEnabled = 0;
    defparam sectimer.DeviceFamily = "PSoC4";
    defparam sectimer.InterruptOnCapture = 0;
    defparam sectimer.InterruptOnTC = 0;
    defparam sectimer.Resolution = 16;
    defparam sectimer.SiliconRevision = "0";
    ...
    DieTemp_P4_v1_0_3 coretemp (
        .temp(Net_638));

	wire [0:0] tmpOE__P7_1_net;
	wire [0:0] tmpIO_0__P7_1_net;
	electrical [0:0] tmpSIOVREF__P7_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		P7_1
		 (.oe(tmpOE__P7_1_net),
		  .y({1'b0}),
		  .fb({Net_912}),
		  .io({tmpIO_0__P7_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P7_1_net),
		  .interrupt({Net_993}),
		  .annotation({Net_911}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__P7_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 user (
        .connect({
            Net_911,
            Net_902
        })
    );
    defparam user.comp_name = "SwitchSPST_v1_0";
    defparam user.port_names = "T1, T2";
    defparam user.width = 2;
	...
	wire [0:0] tmpOE__en5v_gpio0_net;
	wire [0:0] tmpFB_0__en5v_gpio0_net;
	wire [0:0] tmpIO_0__en5v_gpio0_net;
	wire [0:0] tmpINTERRUPT_0__en5v_gpio0_net;
	electrical [0:0] tmpSIOVREF__en5v_gpio0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		en5v_gpio0
		 (.oe(tmpOE__en5v_gpio0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__en5v_gpio0_net[0:0]}),
		  .io({tmpIO_0__en5v_gpio0_net[0:0]}),
		  .siovref(tmpSIOVREF__en5v_gpio0_net),
		  .interrupt({tmpINTERRUPT_0__en5v_gpio0_net[0:0]}),
		  .annotation({Net_956}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__en5v_gpio0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__gpio1_led_net;
	wire [0:0] tmpFB_0__gpio1_led_net;
	wire [0:0] tmpIO_0__gpio1_led_net;
	wire [0:0] tmpINTERRUPT_0__gpio1_led_net;
	electrical [0:0] tmpSIOVREF__gpio1_led_net;

	cy_psoc3_pins_v1_10
		#(.id("953da434-9ae3-48d8-b944-9f80cab68124"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio1_led
		 (.oe(tmpOE__gpio1_led_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio1_led_net[0:0]}),
		  .io({tmpIO_0__gpio1_led_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio1_led_net),
		  .interrupt({tmpINTERRUPT_0__gpio1_led_net[0:0]}),
		  .annotation({Net_1237}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio1_led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__en5v_gpio1_net;
	wire [0:0] tmpFB_0__en5v_gpio1_net;
	wire [0:0] tmpIO_0__en5v_gpio1_net;
	wire [0:0] tmpINTERRUPT_0__en5v_gpio1_net;
	electrical [0:0] tmpSIOVREF__en5v_gpio1_net;

	cy_psoc3_pins_v1_10
		#(.id("d4e39cb3-e702-4d46-b2f2-ffd7daba4586"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		en5v_gpio1
		 (.oe(tmpOE__en5v_gpio1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__en5v_gpio1_net[0:0]}),
		  .io({tmpIO_0__en5v_gpio1_net[0:0]}),
		  .siovref(tmpSIOVREF__en5v_gpio1_net),
		  .interrupt({tmpINTERRUPT_0__en5v_gpio1_net[0:0]}),
		  .annotation({Net_957}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__en5v_gpio1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__en33v_gpio1_net;
	wire [0:0] tmpFB_0__en33v_gpio1_net;
	wire [0:0] tmpIO_0__en33v_gpio1_net;
	wire [0:0] tmpINTERRUPT_0__en33v_gpio1_net;
	electrical [0:0] tmpSIOVREF__en33v_gpio1_net;

	cy_psoc3_pins_v1_10
		#(.id("bd5c2a09-8cc3-4a4c-b62d-aeff16c16df2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		en33v_gpio1
		 (.oe(tmpOE__en33v_gpio1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__en33v_gpio1_net[0:0]}),
		  .io({tmpIO_0__en33v_gpio1_net[0:0]}),
		  .siovref(tmpSIOVREF__en33v_gpio1_net),
		  .interrupt({tmpINTERRUPT_0__en33v_gpio1_net[0:0]}),
		  .annotation({Net_958}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__en33v_gpio1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sw0_net;
	wire [0:0] tmpIO_0__sw0_net;
	wire [0:0] tmpINTERRUPT_0__sw0_net;
	electrical [0:0] tmpSIOVREF__sw0_net;

	cy_psoc3_pins_v1_10
		#(.id("ac11de20-7a28-4eda-8bef-f7cf992b4731"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		sw0
		 (.oe(tmpOE__sw0_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__sw0_net[0:0]}),
		  .annotation({Net_1265}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__sw0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5fae3724-c84b-4849-8fb0-9ca2226c619e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e2d11dd1-5cac-43e9-8c98-53451b8ec15a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("bc71af0e-84fc-4bdc-95b8-c7bec712f82d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__gpio2_4_net;
	wire [0:0] tmpFB_0__gpio2_4_net;
	wire [0:0] tmpIO_0__gpio2_4_net;
	wire [0:0] tmpINTERRUPT_0__gpio2_4_net;
	electrical [0:0] tmpSIOVREF__gpio2_4_net;

	cy_psoc3_pins_v1_10
		#(.id("6a417ad1-05f7-403f-860a-fe49f8426c3a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio2_4
		 (.oe(tmpOE__gpio2_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio2_4_net[0:0]}),
		  .io({tmpIO_0__gpio2_4_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio2_4_net),
		  .interrupt({tmpINTERRUPT_0__gpio2_4_net[0:0]}),
		  .annotation({Net_1503}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio2_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__dio0_net;
	wire [0:0] tmpIO_0__dio0_net;
	wire [0:0] tmpINTERRUPT_0__dio0_net;
	electrical [0:0] tmpSIOVREF__dio0_net;

	cy_psoc3_pins_v1_10
		#(.id("487d022b-2944-412e-8e85-c3ae1f448577"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		dio0
		 (.oe(tmpOE__dio0_net),
		  .y({1'b0}),
		  .fb({Net_1251}),
		  .io({tmpIO_0__dio0_net[0:0]}),
		  .siovref(tmpSIOVREF__dio0_net),
		  .interrupt({tmpINTERRUPT_0__dio0_net[0:0]}),
		  .annotation({Net_1186}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__dio0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("59d6a023-4d19-4d16-9cdd-5270ef41a75e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7d0ba6a4-1103-460d-afd0-f6e5f516e885"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__nrst_net;
	wire [0:0] tmpFB_0__nrst_net;
	wire [0:0] tmpIO_0__nrst_net;
	wire [0:0] tmpINTERRUPT_0__nrst_net;
	electrical [0:0] tmpSIOVREF__nrst_net;

	cy_psoc3_pins_v1_10
		#(.id("6cfa7024-d1af-49f5-b745-0a8e3e17f7b7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		nrst
		 (.oe(tmpOE__nrst_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__nrst_net[0:0]}),
		  .io({tmpIO_0__nrst_net[0:0]}),
		  .siovref(tmpSIOVREF__nrst_net),
		  .interrupt({tmpINTERRUPT_0__nrst_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__nrst_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 SW_0 (
        .connect({
            Net_1244,
            Net_1265
        })
    );
    defparam SW_0.comp_name = "SwitchSPST_v1_0";
    defparam SW_0.port_names = "T1, T2";
    defparam SW_0.width = 2;

    TCPWM_P4_v2_10_6 flow (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(Net_1550),
	...
	wire [0:0] tmpOE__gpio2_2_net;
	wire [0:0] tmpFB_0__gpio2_2_net;
	wire [0:0] tmpIO_0__gpio2_2_net;
	wire [0:0] tmpINTERRUPT_0__gpio2_2_net;
	electrical [0:0] tmpSIOVREF__gpio2_2_net;

	cy_psoc3_pins_v1_10
		#(.id("f3c7b621-838b-4840-838d-7cbccc7c7ae5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio2_2
		 (.oe(tmpOE__gpio2_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio2_2_net[0:0]}),
		  .io({tmpIO_0__gpio2_2_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio2_2_net),
		  .interrupt({tmpINTERRUPT_0__gpio2_2_net[0:0]}),
		  .annotation({Net_1501}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio2_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__gpio2_5_net;
	wire [0:0] tmpFB_0__gpio2_5_net;
	wire [0:0] tmpIO_0__gpio2_5_net;
	wire [0:0] tmpINTERRUPT_0__gpio2_5_net;
	electrical [0:0] tmpSIOVREF__gpio2_5_net;

	cy_psoc3_pins_v1_10
		#(.id("212e693a-f990-4846-b993-b2d40e901798"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio2_5
		 (.oe(tmpOE__gpio2_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio2_5_net[0:0]}),
		  .io({tmpIO_0__gpio2_5_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio2_5_net),
		  .interrupt({tmpINTERRUPT_0__gpio2_5_net[0:0]}),
		  .annotation({Net_1504}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio2_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__press2_6_net;
	wire [0:0] tmpFB_0__press2_6_net;
	wire [0:0] tmpIO_0__press2_6_net;
	wire [0:0] tmpINTERRUPT_0__press2_6_net;
	electrical [0:0] tmpSIOVREF__press2_6_net;

	cy_psoc3_pins_v1_10
		#(.id("b8091211-7fe1-4d33-994d-1ce14077e26e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		press2_6
		 (.oe(tmpOE__press2_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__press2_6_net[0:0]}),
		  .analog({Net_1580}),
		  .io({tmpIO_0__press2_6_net[0:0]}),
		  .siovref(tmpSIOVREF__press2_6_net),
		  .interrupt({tmpINTERRUPT_0__press2_6_net[0:0]}),
		  .annotation({Net_1586}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__press2_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__flow2_7_net;
	wire [0:0] tmpIO_0__flow2_7_net;
	wire [0:0] tmpINTERRUPT_0__flow2_7_net;
	electrical [0:0] tmpSIOVREF__flow2_7_net;

	cy_psoc3_pins_v1_10
		#(.id("630d0e0e-f865-4b6e-8218-23ec88bda45a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		flow2_7
		 (.oe(tmpOE__flow2_7_net),
		  .y({1'b0}),
		  .fb({Net_1550}),
		  .io({tmpIO_0__flow2_7_net[0:0]}),
		  .siovref(tmpSIOVREF__flow2_7_net),
		  .interrupt({tmpINTERRUPT_0__flow2_7_net[0:0]}),
		  .annotation({Net_1585}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__flow2_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__gpio2_8_net;
	wire [0:0] tmpFB_0__gpio2_8_net;
	wire [0:0] tmpIO_0__gpio2_8_net;
	wire [0:0] tmpINTERRUPT_0__gpio2_8_net;
	electrical [0:0] tmpSIOVREF__gpio2_8_net;

	cy_psoc3_pins_v1_10
		#(.id("c77dd44c-f4fe-4159-884e-93f773c9a2df"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio2_8
		 (.oe(tmpOE__gpio2_8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio2_8_net[0:0]}),
		  .io({tmpIO_0__gpio2_8_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio2_8_net),
		  .interrupt({tmpINTERRUPT_0__gpio2_8_net[0:0]}),
		  .annotation({Net_1509}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio2_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__gpio2_9_net;
	wire [0:0] tmpFB_0__gpio2_9_net;
	wire [0:0] tmpIO_0__gpio2_9_net;
	wire [0:0] tmpINTERRUPT_0__gpio2_9_net;
	electrical [0:0] tmpSIOVREF__gpio2_9_net;

	cy_psoc3_pins_v1_10
		#(.id("9214973f-891a-4089-9b1d-b6564eb24cb8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio2_9
		 (.oe(tmpOE__gpio2_9_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio2_9_net[0:0]}),
		  .io({tmpIO_0__gpio2_9_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio2_9_net),
		  .interrupt({tmpINTERRUPT_0__gpio2_9_net[0:0]}),
		  .annotation({Net_1508}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio2_9_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__gpio2_3_net;
	wire [0:0] tmpFB_0__gpio2_3_net;
	wire [0:0] tmpIO_0__gpio2_3_net;
	wire [0:0] tmpINTERRUPT_0__gpio2_3_net;
	electrical [0:0] tmpSIOVREF__gpio2_3_net;

	cy_psoc3_pins_v1_10
		#(.id("ac3c81d9-8055-473a-b863-7c4b7589bfa7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gpio2_3
		 (.oe(tmpOE__gpio2_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gpio2_3_net[0:0]}),
		  .io({tmpIO_0__gpio2_3_net[0:0]}),
		  .siovref(tmpSIOVREF__gpio2_3_net),
		  .interrupt({tmpINTERRUPT_0__gpio2_3_net[0:0]}),
		  .annotation({Net_1502}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__gpio2_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SW_Tx_UART_v1_50_7 LCD ();
